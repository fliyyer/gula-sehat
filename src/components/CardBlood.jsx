...
const CardBlood = (props) => {
    ...
    return (
        <div className='bg-white shadow-xl p-7 gap-5 rounded-xl flex items-center'>
            <div className='bg-[#FF5B5B] bg-opacity-30 p-2 rounded-full'>
                <img className='w-[70px]' src={Blood} alt="Blood" />
            </div>
            <div>
                <p className='text-[46px] text-[#464255] font-bold'>{value} <span className='text-base'> mg/dL</span></p>
